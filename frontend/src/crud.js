export const cadastroServer = async (nome, email, senha) => {
  try {
    const response = await fetch('https://chat-io-jpz0.onrender.com/users/cadastro', {
      method: 'POST',
...
export const loginServer = async (email, senha) => {
  try {
    const response = await fetch('https://chat-io-jpz0.onrender.com/users/login', {
      method: 'POST',
      headers: { 'Content-type': 'application/json' },
...
export const pesquisarServer = async (e) => {
  try {
    const response = await fetch('https://chat-io-jpz0.onrender.com/pesquisa/' + e);
...
export const getUserServer = async () => {
  try {
    const response = await fetch('https://chat-io-jpz0.onrender.com/users/perfil', {
      method: 'GET',
      credentials: 'include'
    });
...
export const buscarMensagensServer = async (de, para) => {
  try {
    const response = await fetch('https://chat-io-jpz0.onrender.com/mensagens-antigas', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
export const changeImagePerfilServer = async (imageSrc, id) => {
  try {
    ...
    const response = await fetch('https://chat-io-jpz0.onrender.com/image', {
      method: 'POST',
      body: formData
    });
...
export const getUsersTalkServer = async (data) => {
  try {
    const response = await fetch('https://chat-io-jpz0.onrender.com/users-talk', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
